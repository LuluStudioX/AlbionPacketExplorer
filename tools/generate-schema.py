...
WIRE_OVERRIDE.update({
    ...
    "EVENT:38": _ev("NewSimpleHarvestableObject", {
        "0": p("objectId", "Int64"),
        "1": p("typeId", "Int16; resource type index"),
        "2": p("tier", "Byte; 1-8"),
        "3": p("position", "Single[2]; {x,y} tile coords"),
        "4": p("size", "Int32; charge count"),
    }),
    "EVENT:39": _ev("NewSimpleHarvestableObjectList", {
        "0": p("objectIds", "Int64[]; array of IDs"),
        "1": p("typeIds", "Int16[]; resource type indices"),
        "2": p("tiers", "Byte[]; 1-8 per object"),
        "3": p("positions", "Single[]; flat {x0,y0,x1,y1,...} tile coords"),
        "4": p("sizes", "Int32[]; charge counts; no enchant (defaults 0 until EVENT:46)"),
    }),
    "EVENT:40": _ev("NewHarvestableObject", {
        "0": p("objectId", "Int64"),
        "2": p("timestamp", ".NET ticks (UTC)"),
        "5": p("typeId", "Int16; resource type index"),
        "7": p("tier", "Byte; 1-8"),
        "8": p("position", "Single[2]; {x,y} tile coords"),
        "10": p("size", "Int32; charge count"),
        "11": p("enchantmentLevel", "Byte; 0-4; absent=0"),
    }),
    "EVENT:46": _ev("HarvestableChangeState", {
        "0": p("objectId", "Int64"),
        "1": p("newSize", "Int32; absent/undefined = resource depleted"),
        "2": p("enchantmentLevel", "Byte; 0-4"),
    }),
    "EVENT:123": _ev("NewMob", {
        "0": p("objectId"),
        "1": p("typeId", "Mob/entity type id"),
        "2": p("flags", "Byte (often 255)"),
        "6": p("name", "Name; present = Mist boss (inferred)"),
        "7": p("position", "Single[] world position {x, y}"),
        "8": p("targetPosition", "Single[] move target {x, y}"),
        "10": p("heading", "Single facing/angle"),
        "11": p("speed", "Single move speed"),
        "13": p("health", "Single current health; <10 at spawn may be default"),
        "14": p("maxHealth", "Single max health"),
        "19": p("rarity", "Int32; mob rarity tier (inferred)"),
        "33": p("enchantmentLevel", "Byte; 0-4"),
    }),
})
