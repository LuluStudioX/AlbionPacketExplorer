...
// EVENT [30] NewEquipmentItem
public sealed class NewEquipmentItemEvent
{
    public long ObjectId { get; }
    public int ItemId { get; }
    public int Quantity { get; }
    public long EstimatedMarketValue { get; }
    public short QualityLevel { get; }
    public long Durability { get; }

    public NewEquipmentItemEvent(Dictionary<byte, object> p)
    {
        ...
        if (p.TryGetValue(6, out var v6)) QualityLevel = v6.ObjectToShort();
